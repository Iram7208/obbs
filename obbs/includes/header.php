                    ...
                    <div class="header-top-grids">
                        ...
                        <div class="collapse navbar-collapse nav-wil">
                            <ul  style="color: white; ">
                                <li class='Navebar_li' ><a href="login.php">Login</a></li>
                                            <li class='Navebar_li' > <a href="signup.php">Register</a></li>
                                            <li class='Navebar_li'><a href="admin/login.php">Admin</a></li>
                               <?php } ?>
                            </ul>
